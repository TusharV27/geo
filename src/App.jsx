...
const App = () => {
  ...
  useEffect(() => {
    ...
    if (notificationPermission === 'default') {
      Notification.requestPermission().then((permission) => {
        ...
        if (permission !== 'granted') {
          setError('Notifications are not allowed.');
        }
      });
    }
  ...
  return (
    <div>
      ...
      {error && <p>Error: {error}</p>}
      {notificationPermission === 'default' && <p>Waiting for notification permission...</p>}
      {locationPermission === 'denied' && <p>Location access is denied.</p>}
    </div>
  );
};
